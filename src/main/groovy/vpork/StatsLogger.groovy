...
public class StatsLogger {
    ...
    void printStats() {
        ...
        logAndPrint sprintf("  Write Latency std deviation :  %.2f", writeTimes.getStandardDeviation())
        ...
        logAndPrint sprintf("  Read Latency std deviation:         %.2f", readTimes.getStandardDeviation())
